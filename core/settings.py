...
SECRET_KEY = 'django-insecure-z3y)0#h!(*#j-*6t+)8ep_stkob(adw6bvrdw9)+3yeaxsp9jg'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mangadb',  # Имя вашей базы данных
        'USER': 'mangauser',      # Имя вашего пользователя
        'PASSWORD': 'mangapass',  # Ваш пароль
